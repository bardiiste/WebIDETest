jQuery.sap.declare("ZHR_ABSENCE_MANAGEMENT.util.messages");
...
ZHR_ABSENCE_MANAGEMENT.util.messages = {};
...
ZHR_ABSENCE_MANAGEMENT.util.messages.showErrorMessage = function(oParameter) {



	var oErrorDetails = ZHR_ABSENCE_MANAGEMENT.util.messages._parseError(oParameter);
...
ZHR_ABSENCE_MANAGEMENT.util.messages.getErrorContent = function(oParameter) {



	return ZHR_ABSENCE_MANAGEMENT.util.messages._parseError(oParameter).sMessage;
...
ZHR_ABSENCE_MANAGEMENT.util.messages._parseError = function(oParameter) {
