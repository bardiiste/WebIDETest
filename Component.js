...
jQuery.sap.declare("ZHR_ABSENCE_MANAGEMENT.Component");
...
sap.ui.core.UIComponent.extend("ZHR_ABSENCE_MANAGEMENT.Component", {



    metadata : {

        "name" : "ZHR_ABSENCE_MANAGEMENT",

        "version" : "1.1.0-SNAPSHOT",

        "library" : "ZHR_ABSENCE_MANAGEMENT",
		...
		"config" : {
			...
			serviceConfig : {
				...
				name: "ZABSENCE_PO_SRV",

				serviceUrl: "/sap/opu/odata/sap/ZABSENCE_PO_SRV/"
        ...
        routing : {
            ...
            config : {
                ...
                "viewPath" : "ZHR_ABSENCE_MANAGEMENT.view",
    ...
    createContent : function() {
        ...
        return sap.ui.view({
            ...
            viewName : "ZHR_ABSENCE_MANAGEMENT.view.Main",
    ...
    init : function() {
        ...
        var sRootPath = jQuery.sap.getModulePath("ZHR_ABSENCE_MANAGEMENT");
    ...
    _initODataModel : function(sServiceUrl) {
        ...
        jQuery.sap.require("ZHR_ABSENCE_MANAGEMENT.util.messages");
        ...
        oModel.attachRequestFailed(null, ZHR_ABSENCE_MANAGEMENT.util.messages.showErrorMessage);
